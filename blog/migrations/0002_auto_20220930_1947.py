# Generated by Django 3.2.15 on 2022-09-30 22:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aluno_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.aluno')),
                ('empresa_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.empresa')),
                ('escola_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.escola')),
            ],
        ),
        migrations.CreateModel(
            name='Financeiro',
            fields=[
                ...
                ('ficha_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.ficha')),
            ],
        ),
        migrations.CreateModel(
            name='Professor',
        ...
        migrations.AddField(
            model_name='ficha',
            name='professor_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.professor'),
        ),
        migrations.AddField(
            model_name='ficha',
            name='responsavel_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.responsavel'),
        ),
        migrations.AddField(
            model_name='ficha',
            name='valores_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.valores'),
        ),
        migrations.AddField(
            model_name='chamada',
            name='ficha_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.ficha'),
        ),
    ]
